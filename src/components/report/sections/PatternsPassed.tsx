  ...
  return (
    <section className="flex flex-col gap-3" data-section="patterns-passed">
      ...
      {data.groups.length === 0 ? (
        <p className="text-small text-muted-foreground">No patterns passed yet. They appear here once a chain closes.</p>
      ) : (
        <div className="flex flex-col gap-3">
          {data.groups.map(group => (
            <div key={group.cloId} className="flex flex-wrap items-center gap-2">
